...
public class Package extends ContainerEntity implements TCanBeStub, TEntityMetaLevelDependency, TImportable, TNamedEntity, TPackage, TPackageable, TSourceEntity, TWithComments {
