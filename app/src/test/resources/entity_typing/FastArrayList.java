...
public class FastArrayList extends ArrayList {
	...
	/**
	 * Increase the capacity of this <code>ArrayList</code> instance, if necessary,
	 ...
	 * documentation for the <code>List.equals</code> method.
	 *
	...
	/**
	 * Return the hash code value for this list. This implementation uses exactly
	 * the code that is used to define the list hash function in the documentation
	 * for the <code>List.hashCode</code> method.
	 */
	public int hashCode() {
	...
	/**
	 * Search for the first occurrence of the given argument, testing for equality
	 * using the <code>equals()</code> method, and return the corresponding index,
	 ...
	 * <br>
	 * <strong>IMPLEMENTATION NOTE</strong> - If the list is operating in fast mode,
	 * an Iterator is returned, and a structural modification to the list is made,
	 * then the Iterator will continue over the previous contents of the list (at
	 * the time that the Iterator was created), rather than failing due to
	...
	/**
	 * Search for the last occurrence of the given argument, testing for equality
	 * using the <code>equals()</code> method, and return the corresponding index,
	 * or -1 if the object is not found.
	 *
	 * @param element The element to search for
	...
	/**
	 * Return an iterator of the elements of this list, in proper sequence. See the
	 * implementation note on <code>iterator()</code>.
	 */
	...
	/**
	 * Return an iterator of the elements of this list, in proper sequence, starting
	 * at the specified position. See the implementation note on
	 * <code>iterator()</code>.
	 *
	...
	/**
	 * Remove the element at the specified position in the list, and shift any
	 * subsequent elements down one position.
	 *
	...
	/**
	 * Remove the first occurrence of the specified element from the list, and shift
	...
	/**
	 * Remove from this collection all of its elements that are contained in the
	 * specified collection.
	 *
	 * @param collection Collection containing elements to be removed
	 *
	 * @exception UnsupportedOperationException if this optional operation is not
	 ...
	 * element. Returns the previous object at that position. <br>
	 * <br>
	...
	/**
	 * Return a view of the portion of this list between fromIndex (inclusive) and
	 * toIndex (exclusive). The returned list is backed by this list, so
	 * non-structural changes in the returned list are reflected in this list. The
	 * returned list supports all of the optional list operations supported by this
	 * list.
	 *
	 ...
	 *
	 * @exception ArrayStoreException if the runtime type of <code>array</code> is
	...
	/**
	 * Trim the capacity of this <code>ArrayList</code> instance to be the list's
	 * current size. An application can use this operation to minimize the storage
	 * of an <code>ArrayList</code> instance.
	 */
