...
public class VerveineJTest_ImplicitVarBinding extends VerveineJTest_Basic {
	...
	public void testUniqForMethod() {
		assertEquals(getImplicitVar(mth1, EntityDictionary.SELF_NAME),
				getImplicitVar(mth1, EntityDictionary.SELF_NAME));
		assertEquals(getImplicitVar(mth1, EntityDictionary.SUPER_NAME),
				getImplicitVar(mth1, EntityDictionary.SUPER_NAME));
	}
	...
	public void testDiffForMethods() {
		assertNotEquals(getImplicitVar(mth1, EntityDictionary.SELF_NAME),
				getImplicitVar(mth2, EntityDictionary.SELF_NAME));
		assertNotEquals(getImplicitVar(mth1, EntityDictionary.SUPER_NAME),
				getImplicitVar(mth2, EntityDictionary.SUPER_NAME));
	}
